...
class StudyPlanMaker:
    ...
    def set_tasks(self):
        ...
        with open("tasks.txt") as f:  # C:/Users/fyi77/pp/CsFolder/Congressional/tasks.txt
            # for every task in tasks, split and append to the tasks list with LongTerm or Priority or None
            for x in f:
                c = x.split(" - ")
                # TODO - when getting the first result, turn into int() in C#
    ...
    def set_plan(self):
        ...
        with open("plan.txt") as f:  # C:/Users/fyi77/pp/CsFolder/Congressional/plan.txt
            started_day = False
            for x in f:
    ...
    def write_final_plan(self):
        ...
        with open("final_plan.txt", "w+") as f:  # C:/Users/fyi77/pp/CsFolder/Congressional/final_plan.txt
    ...
    def make_plan(self):
        ...
        # Adding the relax hours into the file
        for key in plan:
            self.relax_hours += plan[key][-1]
